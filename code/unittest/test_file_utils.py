...
class TestPathUtils(unittest.TestCase):
    ...
    def test_path_validation(self):
        """パス検証機能テスト"""
        try:
            from code.py.modules.shared_modules.file_utils import PathUtils
...
class TestFileSearch(unittest.TestCase):
    ...
    def test_find_files_by_extension(self):
        """拡張子によるファイル検索テスト"""
        try:
            from code.py.modules.shared_modules.file_utils import FileSearch
...
class TestBackupUtilities(unittest.TestCase):
    ...
    def test_create_backup(self):
        """バックアップ作成テスト"""
        try:
            from code.py.modules.shared_modules.file_utils import BackupManager
...
class TestStringUtils(unittest.TestCase):
    ...
    def test_clean_text(self):
        """テキストクリーニングテスト"""
        try:
            from code.py.modules.shared_modules.file_utils import StringUtils
