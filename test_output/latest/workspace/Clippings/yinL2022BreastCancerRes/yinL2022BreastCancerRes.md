...
ai_content:
  ochiai_format:
    generated_at: '2025-06-17T09:38:19.749500'
    questions: !!python/object/apply:collections.OrderedDict
    - - - what_is_this
        - 乳がんにおいて、ケラチン13（KRT13）が幹細胞性を促進し、転移を引き起こすメカニズムを解明した研究。KRT13が細胞の増殖、移動、浸潤を促進し、プラコグロビン（PG）との相互作用を通じてc-Mycシグナル経路を調節することを明らかにした。
      - - what_is_superior
        - 従来の研究では知られていなかったKRT13の乳がんにおける oncogenic（がん促進）な役割を初めて明確に示した点。特に、KRT13と幹細胞性、上皮間葉転換（EMT）、転移との関連性を詳細に解明した点が優れている。
      - - technical_key
        - KRT13がプラコグロビン（PG）と直接相互作用し、その発現と核内移行を変化させ、c-Mycシグナル経路を調節するメカニズム。この相互作用により、がん細胞の幹細胞様特性と浸潤能が増強される。
      - - validation_method
        - in vitroおよびin vivoの実験系を用いて検証。MCF7乳がん細胞株でKRT13の過剰発現と抑制実験を行い、細胞増殖、移動、浸潤能を評価。さらに、無胸腺マウスでの腫瘍形成と転移実験も実施。
      - - discussion_points
        - KRT13の発現が乳がんの進展と転移にどのように関与するかの詳細なメカニズムを解明した一方で、他のがん種での検証や臨床応用に向けてさらなる研究が必要。特に治療標的としての可能性に関する追加検証が課題。
      - - next_papers
        - '1. KRT13の他のがん種での役割に関する研究

          2. c-Mycシグナル経路を標的とした治療法の開発に関する論文

          3. プラコグロビンと intermediate filamentsの相互作用に関する研究'
citation_key: yinL2022BreastCancerRes
citation_metadata:
  last_updated: '2025-06-17T09:38:07.630142'
  mapping_version: '2.0'
...
last_updated: '2025-06-17T09:38:07.534547'
paper_structure:
  parsed_at: '2025-06-17T09:38:07.533278'
  section_types_found:
  - abstract
  - introduction
  - methods
...
sync_metadata:
  ...
  checked_at: '2025-06-17T09:38:06.439615'
...
Importantly, PG may be translocated to the nucleus. Both cytoplasmic and nuclear PGs could function to suppress tumor growth and metastasis \[[^14], [^45]\] by modulating the expression of genes involved in stemness, cell-cycle control and cell invasion \[[^16], [^17]\]. The expressions of some important regulatory proteins, such as P53 \[[^15]\], c-Myc \[[^46]\], SOX4 \[[^47]\] and CD133 \[[^48]\], are all under PG modulation. Nuclear PG is capable of interacting with Tcf/Lef transcription factors to inhibit downstream genes in the Wnt signaling pathway, including c-Myc \[[^49], [^50]\]. In our study, PG expression and nuclear translocation were reduced following KRT13-overexpression (Fig. [5](https://breast-cancer-research.biomedcentral.com/articles/10.1186/s13058-022-01502-6#Fig5)). The reduced PG level may relieve inhibition of c-Myc gene expression, resulting in up-regulated c-Myc driving cancer EMT, stemness and tumor metastasis (Fig. [6](https://breast-cancer-research.biomedcentral.com/articles/10.1186/s13058-022-01502-6#Fig6)). Conversely, KRT13 silencing increased PG expression and nuclear translocation, decreasing EMT, stemness, tumor growth and metastasis. This probability was further strengthened by single cell mQDL staining of clinical breast cancer tissues, which demonstrated that KRT13 expression was inversely correlated with PG, which was inversely correlated with c-Myc (Fig. [6](https://breast-cancer-research.biomedcentral.com/articles/10.1186/s13058-022-01502-6#Fig6)). The molecular mechanisms by which PG regulates c-Myc levels in breast cancer cells need to be investigated further.
